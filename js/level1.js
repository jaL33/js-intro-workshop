...
//arithmetic operators can also be used in alerts
...
var sub = (divide(10,5));
console.log("Divided value", sub);

} else if ("*") {

var test = (multiply(10,5));
console.log("Multiplied value", test);
