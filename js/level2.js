...
var favouriteFood = ['burger','pizza','salad','chicken'];

console.log ("My favourite food", favouriteFood);
...
console.log ("My favourite:", favouriteFood.length);
...
console.log("**iteration exercise");

for(var i=0; i<favouriteFood.length;i++){

    console.log('I love to eat ' + favouriteFood[i]);
}
